...
const { VoiceRecorder } = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"];
let Tab1Page = class Tab1Page {
    ...
    startRecording() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            VoiceRecorder.addListener('audioRecorded', (data) => {
                console.log(data.recordDataBase64.length);
                const dataArr = Float32Array.from(atob(data.recordDataBase64)
                    .split('')
                    .map(char => char.charCodeAt(0)));
                console.log(dataArr.length);
                // const wav = this.encodeWAV(dataArr);
                // console.log(wav);
                fetch('/assets/test.wav')
                    .then((response) => response.arrayBuffer())
                    .then((wav) => {
